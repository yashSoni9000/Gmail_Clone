<%@ Page Title="" Language="C#" MasterPageFile="~/Gmail.master" AutoEventWireup="true" CodeFile="inbox.aspx.cs" Inherits="inbox" %>
            ...
            <ItemTemplate>
                ...
                <div class="message-group-hidden" >
                  <div class="inbox-message-item-options">
                        ...
                        <asp:LinkButton ID="LinkButton1" runat="server" OnCommand="DeleleMail_Btn" CommandName='<%# Eval("id") %>'>
